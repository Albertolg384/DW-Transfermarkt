...
def validate_full_etl():
    ...
    if db_fact_games > 0:
        ...
        print("\n    TABLA VACÍA - Ejecuta primero el ETL de fact_games")
    ...
    if db_appearances > 0:
        ...
        print("    TABLA VACÍA - Ejecuta primero el ETL de fact_appearances")
    ...
    if db_events > 0:
        ...
        print("    TABLA VACÍA - Ejecuta primero el ETL de fact_game_events")
    ...
    if db_transfers > 0:
        ...
        print("    TABLA VACÍA - Ejecuta primero el ETL de fact_transfers")
    ...
    if db_valuations > 0:
        ...
        print("    TABLA VACÍA - Ejecuta primero el ETL de fact_player_valuations")
    ...
    if facts_empty:
        print("\n" + "" * 40)
        print("  LAS TABLAS DE HECHOS ESTÁN VACÍAS")
        print("" * 40)
