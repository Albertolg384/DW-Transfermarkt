...
def etl_dim_competitions():
    """Extrae, transforma y carga la dimension de competiciones"""
    print("ETL: dim_competitions")
    print("=" * 60)
    
    # EXTRACT
    print("Extrayendo competitions.csv...")
    ...
    # Validacion: asegurar que competition_id no sea nulo.
    ...
    # LOAD
    print("Cargando a PostgreSQL (dwh.dim_competitions)...")
    engine = get_engine()
    ...
    with engine.connect() as conn:
        ...
        print(f"Verificacion: {count:,} registros en dwh.dim_competitions\n")
